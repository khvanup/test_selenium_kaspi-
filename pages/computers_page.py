...
class computers_class(Base):
    ...
    locator_sort_expensive = "//*[@id='scroll-to']/div[3]/div/div/div[2]/ul/li[3]"
    locator_product_1 = "//*[@id='scroll-to']/div[4]/div[1]/div[1]"

    def activities_computer_class(self, title_category):
        self.pause()
        ...
        save_title_category_page = self.getter(self.locator_category).text.replace('\n',' ')
        ...
        self.pause()
        self.click_item(self.locator_sort_click)  # сортировка по возрастанию цены
        ...
        self.pause()
        self.click_item(self.locator_product_1)    # выбираем первый продукт
